...
<!-- Processes and sends the email -->
		...
		<?php
            ...
            if(!isset($_POST["submit"]) || !isset($_POST["fname"]) || !isset($_POST["lname"]) || !isset($_POST["email"]) || !isset($_POST["subject"]) || !isset($_POST["sr"]))
                echo("<p> Sorry. We could not process your message at this time. Please try again later. </p>");
            else{
            ...
            $mail->Subject = 'Dulceria China - Message Received';
            //Read an HTML message body from an external file, convert referenced images to embedded,
            //convert HTML into a basic plain-text alternative body
            $mail->Body = "<p> Dear ".$_POST["fname"].' '.$_POST["lname"]. ", </p>
                <p> We have successfully received your message. </p>
                <p> Here is the message we have received: </p>
                <blockquote>".$_POST["sr"]."</blockquote>
                <p> We will respond to your message as soon as possible, and will contact you via your email (".$_POST["email"].")
                or through the telephone number you provided (".$_POST['subject'].") </p>
                <p> We thank you for your message, </p>
                <p> Dulceria China </p>";
