...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Guava Bites | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, guava bites"/>
	    <meta name = "description" content = "Delicious guava bites"/>
    ...
    <body>
        ...
        <div class = "menuItem banner">
            <h3> Guava Bites </h3>
            <figure>
                <img src = "../Styles/Guava bites.jpg" alt = "Guava Bites" class = "small_brush"/>
                <figcaption> Delicious Guava Bites! </figcaption>
            </figure>
        ...
        <div class = "not_banner description">
            <h4> Description </h4>
            <p>
                Our guava bites are incredible. They're the best snack you'll find in the area. They're also only $0.60 a piece!
            </p>
        </div>
        ...
        <div class = "banner ingredients">
            <h4> Ingredients </h4>
            <p>
                Our guava bites contain wheat flour, eggs, condensed milk. powdered milk, and guava paste.
            </p><br/>
        </div>
        <br/>
