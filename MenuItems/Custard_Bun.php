...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Custard Bun | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, custard bun"/>
	    <meta name = "description" content = "Delicious custard bun"/>
    ...
    <body>
        ...
        <div class = "menuItem banner">
            <h3> Custard Bun </h3>
            <figure>
                <img src = "../Styles/Custard bun.jpg" alt = "Custard Bun" class = "small_brush"/>
                <figcaption> Delicious Custard Bun! </figcaption>
            </figure>
        ...
        <div class = "not_banner description">
            <h4> Description </h4>
            <p>
                If you're in the mood for a delicious snack, why not try some of our custard buns?
                They're delicious, sweet, and will leave you wanting more. They're just $0.80 a piece!
            </p>
        </div>
        ...
        <div class = "banner ingredients">
            <h4> Ingredients </h4>
            <p>
                Our custard buns are made with wheat flour, water, sugar, dry yeast, baking powder, vegetable oil,
                salt, and custard.
            </p><br/>
        </div>
        <br/>
