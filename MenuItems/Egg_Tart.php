...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Egg Tart | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, egg tart"/>
	    <meta name = "description" content = "Delicious egg tart"/>
    ...
    <body>
        ...
        <div class = "menuItem banner">
            <h3> Egg Tart </h3>
            <figure>
                <img src = "../Styles/Egg tart.jpg" alt = "Egg Tart" class = "small_brush"/>
                <figcaption> Delicious Egg Tarts! </figcaption>
            </figure>
        ...
        <div class = "not_banner description">
            <h4> Description </h4>
            <p>
                Our egg tarts are absolutely delicious. Try one bite and we'll gauarantee that you'll be back for more. 
                They're only $1.00 a piece, so what are you waiting for? Come on down to our bakery!
            </p>
        </div>
        ...
        <div class = "banner ingredients">
            <h4> Ingredients </h4>
            <p>
                Our egg tarts contain wheat flour, eggs, evaporated milk, sugar, water, butter, and custard power.
            </p><br/>
        </div>
        <br/>
