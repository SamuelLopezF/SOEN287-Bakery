...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Almond Cookies | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, almond cookies"/>
	    <meta name = "description" content = "Delicious almond cookies."/>
    ...
    <body>
        ...
        <div class="not_banner">
            <?php
            include '../db_conn.php';
            $sql = "SELECT * FROM products WHERE type='biscuit';";
