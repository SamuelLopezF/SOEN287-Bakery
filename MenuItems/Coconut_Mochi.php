...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Coconut Mochi | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, coconut mochi"/>
	    <meta name = "description" content = "Delicious coconut mochi"/>
    ...
    <body>
        ...
        <div class = "menuItem banner">
            <h3> Coconut Mochi </h3>
            <figure>
                <img src = "../Styles/Coconut mochi.jpg" alt = "Coconut Mochi" class = "small_brush"/>
                <figcaption> Delicious Coconut Mochi! </figcaption>
            </figure>
        ...
        <div class = "not_banner description">
            <h4> Description </h4>
            <p>
                Our coconut mochis are some of the best in the area. They're delicious and mouth-watering.
                So come on down to our bakery to try some for yourself! They're only $1.00 a piece.
            </p>
        </div>
        ...
        <div class = "banner ingredients">
            <h4> Ingredients </h4>
            <p>
                Our coconut mochis are made with flour, sugar, water, coconuts, and peanuts.
            </p><br/>
        </div>
        <br/>
