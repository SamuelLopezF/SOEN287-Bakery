...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Coconut Bun | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, coconut bun"/>
	    <meta name = "description" content = "Delicious coconut bun"/>
    ...
    <body>
        ...
        <div class = "menuItem banner">
            <h3> Coconut Bun </h3>
            <figure>
                <img src = "../Styles/Coconut bun22.jpg" alt = "Coconut Bun" class = "small_brush"/>
                <figcaption> Delicious Coconut Bun! </figcaption>
            </figure>
        ...
        <div class = "not_banner description">
            <h4> Description </h4>
            <p>
                Our coconut buns are a treat to be desired. They're everything you could want from a bun and more! 
                You can get some from our bakery for only $0.80.
            </p>
        </div>
        ...
        <div class = "banner ingredients">
            <h4> Ingredients </h4>
            <p>
                Our coconut buns are made with wheat flour, water, sugar, dry yeast, baking powder, vegetable oil, salt, and coconut.
            </p><br/>
        </div>
        <br/>
