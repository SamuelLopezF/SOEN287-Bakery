...
<html lang = "en">
    <!-- Head -->
    <head>
        <title> Red Bean Paste Bun | Dulceria China </title>
        <meta charset="UTF-8">
        <meta name = "viewport" content = "width=device-width, initial-scale=1.0"/>
	    <meta name = "keywords" content = "dulceria china, restaurant, bakery, red bean paste bun"/>
	    <meta name = "description" content = "Delicious red bean paste bun"/>
    ...
    <body>
        ...
        <div class = "menuItem banner">
            <h3> Red Bean Paste Bun </h3>
            <figure>
                <img src = "../Styles/RBP22.jpg" alt = "Red Bean Paste Bun" class = "small_brush"/>
                <figcaption> Delicious Red Bean Paste Bun! </figcaption>
            </figure>
        ...
        <div class = "not_banner description">
            <h4> Description </h4>
            <p>
                Our red bean paste buns are both delicious and nutritious. So come on down to our store and try a piece!
                They're just $0.80!
            </p>
        </div>
        ...
        <div class = "banner ingredients">
            <h4> Ingredients </h4>
            <p>
                Our red bean paste buns contain Wheat flour, water, sugar, dry yeast, baking powder, vegetable oil, salt, and red bean paste.
            </p><br/>
        </div>
        <br/>
