var mymap = L.map('mapid').setView([45.495675, -73.578667], 14);
var circle = L.circle([45.495675, -73.578667], {
    color: 'green',
    ...
    xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            try {
                ...
                var latlng = L.latLng(45.495675, -73.578667);
                ...
                L.polyline([[45.495675, -73.578667], [myArr[0].lat, myArr[0].lon]],{color:'green'}).addTo(mymap).bindPopup(km+"km");
